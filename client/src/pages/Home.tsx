...
import { ArrowUpRight, Check, ChevronDown, MapPin, Menu, Phone, Sparkles, X } from "lucide-react";
  ...
  return (
    <div className="site-shell">
      ...
      <main id="beranda">
        ...
        <section className="closing-section section-pad" id="kontak"><div className="closing-card"><div><div className="section-kicker">08 — Hubungi kami</div><h2>Siap menyiapkan<br /><em>momen syukur?</em></h2></div><div className="closing-actions"><p>Jangan ragu bertanya. Kami siap membantu dari pilihan kambing sampai paket yang paling pas untuk keluarga.</p><a className="button button-primary" href={whatsappUrl} target="_blank" rel="noreferrer">Mulai ngobrol <ArrowUpRight size={17} /></a><a className="phone-link" href="tel:+6285211885000"><Phone size={16} /> 0852 1188 5000</a><div className="location-links" aria-label="Lokasi JuraganKambing"><a className="location-link" href="https://maps.app.goo.gl/ujGKjdNPbJvq3rkU7?g_st=ac" target="_blank" rel="noreferrer"><MapPin size={17} /><span><strong>Alamat Pemasaran</strong><small>Bojongsari — Kota Depok</small></span><ArrowUpRight size={15} /></a><a className="location-link" href="https://maps.app.goo.gl/HHwaEs8Q2F6v1gGg6?g_st=ac" target="_blank" rel="noreferrer"><MapPin size={17} /><span><strong>Kandang &amp; RPH</strong><small>Setu — Tangerang Selatan</small></span><ArrowUpRight size={15} /></a></div></div></div></section>
      </main>
