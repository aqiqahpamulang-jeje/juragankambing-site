...
const logoImage = imagePath("logo-juragankambing-256.webp");
...
const services = [
  { number: "01", name: "Katering", image: imagePath("layanan-katering.webp"), description: "Menyediakan katering dengan menu beragam untuk berbagai acara. Mulai dari menu tradisional hingga modern dengan cita rasa terbaik.", items: ["Menu customizable", "Penyajian profesional", "Kapasitas fleksibel"] },
  { number: "02", name: "Kambing Guling", image: imagePath("layanan-kambing-guling.webp"), description: "Kambing guling dengan daging pilihan, dimasak dengan bumbu khas yang lezat. Cocok untuk acara keluarga, arisan, dan gathering.", items: ["Daging berkualitas premium", "Bumbu khas yang lezat", "Pengiriman tepat waktu"] },
  ...
  { number: "06", name: "Tumpeng", image: imagePath("layanan-tumpeng.webp"), description: "Hidangan tumpeng nasi kuning lezat dengan lauk pauk melimpah. Sempurna untuk acara syukuran, arisan, dan perayaan khusus lainnya.", items: ["Nasi kuning premium", "Lauk pauk variatif", "Porsi bisa disesuaikan"] },
];
...
const packages = [
  { name: "Aqiqah 1 ekor Hemat", price: "Rp 1.700.000", unitPrice: 1700000, detail: "160 tusuk sate & 40 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, dan acar.", accent: "olive", image: imagePath("paket-hemat.webp"), items: ["Kambing sehat sesuai syariat", "Masakan olahan kambing", "Nasi box siap dibagikan"] },
  { name: "Aqiqah 1 ekor Standar", price: "Rp 1.900.000", unitPrice: 1900000, detail: "240 tusuk sate & 60 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, acar, dan kerupuk.", accent: "orange", image: imagePath("paket-standar.webp"), items: ["Kambing sehat sesuai syariat", "Porsi sate dan gulai lebih banyak", "Dokumentasi proses"] },
  { name: "Aqiqah 1 ekor Super", price: "Rp 2.200.000", unitPrice: 2200000, detail: "320 tusuk sate & 80 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, acar, kerupuk, dan sayur pelengkap.", accent: "clay", image: imagePath("paket-super.webp"), items: ["Kambing pilihan lebih besar", "Menu siap dibagikan", "Kemasan rapi untuk keluarga"] },
  { name: "Aqiqah 1 ekor Istimewa", price: "Rp 2.500.000", unitPrice: 2500000, detail: "400 tusuk sate & 100 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, acar, kerupuk, sayur pelengkap, dan dessert sederhana.", accent: "terracotta", image: imagePath("paket-istimewa.webp"), items: ["Porsi paling lengkap", "Kambing sehat sesuai syariat", "Pendampingan pemesanan"] },
];
  ...
  return (
    <div className="site-shell">
      ...
      <main id="beranda">
        ...
        <section className="services-section section-pad" id="layanan"><div className="services-heading"><div><div className="section-kicker">06 — Untuk momen yang berbeda</div><h2>Layanan <em>yang kami siapkan.</em></h2></div><p>Dari acara keluarga hingga momen berbagi, kami bantu menyiapkan hidangan dan layanan yang terasa dekat, rapi, dan amanah.</p></div><div className="services-grid">{services.map((service) => <article className="service-card" key={service.name}><div className="service-photo"><img src={service.image} alt={`Foto layanan ${service.name}`} loading="lazy" decoding="async" /><span className="service-number">{service.number}</span></div><div className="service-body"><h3>{service.name}</h3><p>{service.description}</p><ul>{service.items.map((item) => <li key={item}>{item}</li>)}</ul><a href={whatsappUrl} target="_blank" rel="noreferrer">Tanya layanan <ArrowUpRight size={15} /></a></div></article>)}</div></section>
