  ...
  return (
    <div className="site-shell">
      ...
      <main id="beranda">
        ...
        <section className="closing-section section-pad" id="kontak"><div className="closing-card"><div><div className="section-kicker">08 — Hubungi kami</div><h2>Siap menyiapkan<br /><em>momen syukur?</em></h2></div><div className="closing-actions"><p>Jangan ragu bertanya. Kami siap membantu dari pilihan kambing sampai paket yang paling pas untuk keluarga.</p><a className="button button-primary" href={whatsappUrl} target="_blank" rel="noreferrer">Mulai ngobrol <ArrowUpRight size={17} /></a><a className="phone-link" href="tel:+6285211885000"><Phone size={16} /> 0852 1188 5000</a></div></div></section>
      </main>
