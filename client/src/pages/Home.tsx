...
const packages = [
  { name: "Aqiqah 1 ekor Hemat", price: "Rp 1.700.000", detail: "160 tusuk sate & 40 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, dan acar.", accent: "olive", image: "/manus-storage/paket-hemat_527e2a94.jpg", items: ["Kambing sehat sesuai syariat", "Masakan olahan kambing", "Nasi box siap dibagikan"] },
  { name: "Aqiqah 1 ekor Standar", price: "Rp 1.900.000", detail: "240 tusuk sate & 60 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, acar, dan kerupuk.", accent: "orange", image: "/manus-storage/paket-standar_92a14080.jpg", items: ["Kambing sehat sesuai syariat", "Porsi sate dan gulai lebih banyak", "Dokumentasi proses"] },
  { name: "Aqiqah 1 ekor Super", price: "Rp 2.200.000", detail: "320 tusuk sate & 80 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, acar, kerupuk, dan sayur pelengkap.", accent: "clay", image: "/manus-storage/paket-super_4a05ea90.jpg", items: ["Kambing pilihan lebih besar", "Menu siap dibagikan", "Kemasan rapi untuk keluarga"] },
  { name: "Aqiqah 1 ekor Istimewa", price: "Rp 2.500.000", detail: "400 tusuk sate & 100 bungkus gulai", menu: "Sate kambing, gulai kambing, nasi putih, sambal, acar, kerupuk, sayur pelengkap, dan dessert sederhana.", accent: "terracotta", image: "/manus-storage/paket-istimewa_cd8a8623.jpg", items: ["Porsi paling lengkap", "Kambing sehat sesuai syariat", "Pendampingan pemesanan"] },
];
